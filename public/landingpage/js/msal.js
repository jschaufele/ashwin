...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	else if (typeof define === "function" && define.amd) define("Msal", [], factory);
...
***************************************************************************** */
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				exports.AAD_INSTANCE_DISCOVERY_ENDPOINT =
					exports.DEFAULT_AUTHORITY + "/discovery/instance?api-version=1.1&authorization_endpoint=";
				/**
				 * @hidden
				 ...
				 * @hidden
				 */
				exports.BlacklistedEQParams = [SSOTypes.SID, SSOTypes.LOGIN_HINT];
				...
				var CryptoUtils = /** @class */ (function () {
					...
					CryptoUtils.createNewGuid = function () {
						...
						if (cryptoObj && cryptoObj.getRandomValues) {
							...
							return (
								CryptoUtils.decimalToHex(buffer[0]) +
								CryptoUtils.decimalToHex(buffer[1]) +
								CryptoUtils.decimalToHex(buffer[2]) +
								CryptoUtils.decimalToHex(buffer[3]) +
								"-" +
								CryptoUtils.decimalToHex(buffer[4]) +
								CryptoUtils.decimalToHex(buffer[5]) +
								"-" +
								CryptoUtils.decimalToHex(buffer[6]) +
								CryptoUtils.decimalToHex(buffer[7]) +
								"-" +
								CryptoUtils.decimalToHex(buffer[8]) +
								CryptoUtils.decimalToHex(buffer[9]) +
								"-" +
								CryptoUtils.decimalToHex(buffer[10]) +
								CryptoUtils.decimalToHex(buffer[11]) +
								CryptoUtils.decimalToHex(buffer[12]) +
								CryptoUtils.decimalToHex(buffer[13]) +
								CryptoUtils.decimalToHex(buffer[14]) +
								CryptoUtils.decimalToHex(buffer[15])
							);
						} else {
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var UrlUtils = /** @class */ (function () {
					...
					UrlUtils.createNavigationUrlString = function (serverRequestParams) {
						console.log("-----MSAL--->serverRequestParams--->", serverRequestParams);
					...
					UrlUtils.constructAuthorityUriFromObject = function (urlObject, pathArray) {
						return this.CanonicalizeUri(
							urlObject.Protocol + "//" + urlObject.HostNameAndPort + "/" + pathArray.join("/")
						);
					};
					/**
					...
					UrlUtils.urlContainsHash = function (urlString) {
						...
						return (
							parameters.hasOwnProperty(Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION) ||
				...
				var ClientConfigurationError = /** @class */ (function (_super) {
					...
					ClientConfigurationError.createNoSetConfigurationError = function () {
						return new ClientConfigurationError(
							...
							"" + exports.ClientConfigurationErrorMessage.configurationNotSet.desc
						);
					};
					ClientConfigurationError.createStorageNotSupportedError = function (givenCacheLocation) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.storageNotSupported.code,
							exports.ClientConfigurationErrorMessage.storageNotSupported.desc +
								" Given location: " +
								givenCacheLocation
						);
					};
					...
					ClientConfigurationError.createInvalidCallbackObjectError = function (callbackObject) {
						return new ClientConfigurationError(
							...
							exports.ClientConfigurationErrorMessage.invalidCallbackObject.desc +
					...
					ClientConfigurationError.createEmptyScopesArrayError = function (scopesValue) {
						return new ClientConfigurationError(
							...
							exports.ClientConfigurationErrorMessage.emptyScopes.desc + " Given value: " + scopesValue + "."
						);
					};
					ClientConfigurationError.createScopesNonArrayError = function (scopesValue) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.nonArrayScopes.code,
							exports.ClientConfigurationErrorMessage.nonArrayScopes.desc + " Given value: " + scopesValue + "."
						);
					};
					ClientConfigurationError.createClientIdSingleScopeError = function (scopesValue) {
						return new ClientConfigurationError(
							...
							exports.ClientConfigurationErrorMessage.clientScope.desc + " Given value: " + scopesValue + "."
						);
					};
					ClientConfigurationError.createScopesRequiredError = function (scopesValue) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.scopesRequired.code,
							exports.ClientConfigurationErrorMessage.scopesRequired.desc + " Given value: " + scopesValue
						);
					};
					ClientConfigurationError.createInvalidPromptError = function (promptValue) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.invalidPrompt.code,
							exports.ClientConfigurationErrorMessage.invalidPrompt.desc + " Given value: " + promptValue
						);
					};
					ClientConfigurationError.createClaimsRequestParsingError = function (claimsRequestParseError) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.claimsRequestParsingError.code,
							exports.ClientConfigurationErrorMessage.claimsRequestParsingError.desc +
								" Given value: " +
								claimsRequestParseError
						);
					};
					ClientConfigurationError.createEmptyRequestError = function () {
						var _a = exports.ClientConfigurationErrorMessage.emptyRequestError,
							code = _a.code,
							desc = _a.desc;
					...
					ClientConfigurationError.createInvalidCorrelationIdError = function () {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.invalidCorrelationIdError.code,
							exports.ClientConfigurationErrorMessage.invalidCorrelationIdError.desc
						);
					};
					ClientConfigurationError.createKnownAuthoritiesNotSetError = function () {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.b2cKnownAuthoritiesNotSet.code,
							exports.ClientConfigurationErrorMessage.b2cKnownAuthoritiesNotSet.desc
						);
					};
					ClientConfigurationError.createInvalidAuthorityTypeError = function () {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.invalidAuthorityType.code,
							exports.ClientConfigurationErrorMessage.invalidAuthorityType.desc
						);
					};
					ClientConfigurationError.createUntrustedAuthorityError = function (host) {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.untrustedAuthority.code,
							exports.ClientConfigurationErrorMessage.untrustedAuthority.desc + " Provided Authority: " + host
						);
					};
					ClientConfigurationError.createTelemetryConfigError = function (config) {
						var _a = exports.ClientConfigurationErrorMessage.telemetryConfigError,
							code = _a.code,
							desc = _a.desc;
						var requiredKeys = {
					...
					ClientConfigurationError.createSsoSilentError = function () {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.ssoSilentError.code,
							exports.ClientConfigurationErrorMessage.ssoSilentError.desc
						);
					};
					ClientConfigurationError.createInvalidAuthorityMetadataError = function () {
						return new ClientConfigurationError(
							exports.ClientConfigurationErrorMessage.invalidAuthorityMetadataError.code,
							exports.ClientConfigurationErrorMessage.invalidAuthorityMetadataError.desc
						);
					};
				...
				var ClientAuthError = /** @class */ (function (_super) {
					...
					ClientAuthError.createMultipleMatchingTokensInCacheError = function (scope) {
						return new ClientAuthError(
							...
							"Cache error for scope " + scope + ": " + exports.ClientAuthErrorMessage.multipleMatchingTokens.desc + "."
						);
					};
					ClientAuthError.createMultipleAuthoritiesInCacheError = function (scope) {
						return new ClientAuthError(
							...
							"Cache error for scope " +
								scope +
								": " +
								exports.ClientAuthErrorMessage.multipleCacheAuthorities.desc +
								"."
						);
					};
					...
					ClientAuthError.createInvalidIdTokenError = function (idToken) {
						return new ClientAuthError(
							...
							exports.ClientAuthErrorMessage.invalidIdToken.desc + " Given token: " + idToken
						);
					};
					...
					ClientAuthError.createInvalidStateError = function (invalidState, actualState) {
						return new ClientAuthError(
							...
							exports.ClientAuthErrorMessage.invalidStateError.desc +
								" " +
								invalidState +
								", state expected : " +
								actualState +
					...
					ClientAuthError.createNonceMismatchError = function (invalidNonce, actualNonce) {
						return new ClientAuthError(
							...
							exports.ClientAuthErrorMessage.nonceMismatchError.desc +
								" " +
								invalidNonce +
								", nonce expected : " +
								actualNonce +
					...
					ClientAuthError.createErrorInCallbackFunction = function (errorDesc) {
						return new ClientAuthError(
							...
							exports.ClientAuthErrorMessage.callbackError.desc + " " + errorDesc + "."
						);
					};
					...
					ClientAuthError.createClientInfoDecodingError = function (caughtError) {
						return new ClientAuthError(
							...
							exports.ClientAuthErrorMessage.clientInfoDecodingError.desc + " Failed with error: " + caughtError
						);
					};
					ClientAuthError.createClientInfoNotPopulatedError = function (caughtError) {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.clientInfoNotPopulatedError.code,
							exports.ClientAuthErrorMessage.clientInfoNotPopulatedError.desc + " Failed with error: " + caughtError
						);
					};
					ClientAuthError.createIdTokenNullOrEmptyError = function (invalidRawTokenString) {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.nullOrEmptyIdToken.code,
							exports.ClientAuthErrorMessage.nullOrEmptyIdToken.desc + " Raw ID Token Value: " + invalidRawTokenString
						);
					};
					ClientAuthError.createIdTokenParsingError = function (caughtParsingError) {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.idTokenNotParsed.code,
							exports.ClientAuthErrorMessage.idTokenNotParsed.desc + " Failed with error: " + caughtParsingError
						);
					};
					ClientAuthError.createTokenEncodingError = function (incorrectlyEncodedToken) {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.tokenEncodingError.code,
							exports.ClientAuthErrorMessage.tokenEncodingError.desc +
								" Attempted to decode: " +
					...
					ClientAuthError.createInvalidInteractionTypeError = function () {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.invalidInteractionType.code,
							exports.ClientAuthErrorMessage.invalidInteractionType.desc
						);
					};
					...
					ClientAuthError.createBlockTokenRequestsInHiddenIframeError = function () {
						return new ClientAuthError(
							exports.ClientAuthErrorMessage.blockTokenRequestsInHiddenIframe.code,
							exports.ClientAuthErrorMessage.blockTokenRequestsInHiddenIframe.desc
						);
					};
				...
				var AuthError = /** @class */ (function (_super) {
					...
					AuthError.createUnexpectedError = function (errDesc) {
						return new AuthError(
							...
							exports.AuthErrorMessage.unexpectedError.desc + ": " + errDesc
						);
					};
					AuthError.createNoWindowObjectError = function (errDesc) {
						return new AuthError(
							exports.AuthErrorMessage.noWindowObjectError.code,
							exports.AuthErrorMessage.noWindowObjectError.desc + " " + errDesc
						);
					};
					return AuthError;
				})(Error);
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var ScopeSet = /** @class */ (function () {
					...
					ScopeSet.appendScopes = function (reqScopes, reqExtraScopesToConsent) {
						if (reqScopes) {
							var convertedExtraScopes = reqExtraScopesToConsent
								? this.trimAndConvertArrayToLowerCase(reqExtraScopesToConsent.slice())
								: null;
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				exports.prependEventNamePrefix = function (suffix) {
					return "" + TelemetryConstants_1.EVENT_NAME_PREFIX + (suffix || "");
				};
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var TelemetryEvent = /** @class */ (function () {
					...
					TelemetryEvent.prototype.start = function () {
						...
						this.event[
							TelemetryUtils_1.prependEventNamePrefix(TelemetryConstants_2.START_TIME_KEY)
						] = this.startTimestamp;
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var UserAgentApplication = /** @class */ (function () {
					...
					function UserAgentApplication(configuration) {
						console.log("----------------INCOMMINGINGIGNGINIG-->", configuration);
						...
						console.log("----------------INCOMMINGINGIGNGINIG 222-->", this.config);

						this.logger = this.config.system.logger;
						this.clientId = this.config.auth.clientId;
						this.inCookie = this.config.cache.storeAuthStateInCookie;
						this.telemetryManager = this.getTelemetryManagerFromConfig(this.config.system.telemetry, this.clientId);
						TrustedAuthority_1.TrustedAuthority.setTrustedAuthoritiesFromConfig(
							this.config.auth.validateAuthority,
							this.config.auth.knownAuthorities
						);
						AuthorityFactory_1.AuthorityFactory.saveMetadataFromConfig(
						...
						this.cacheStorage = new AuthCache_1.AuthCache(
							this.clientId,
					...
					Object.defineProperty(UserAgentApplication.prototype, "authority", {
						...
						set: function (val) {
							this.authorityInstance = AuthorityFactory_1.AuthorityFactory.CreateInstance(
								val,
								this.config.auth.validateAuthority
							);
						},
					...
					UserAgentApplication.prototype.handleRedirectCallback = function (
						...
						if (this.redirectError) {
							this.authErrorHandler(
								Constants_1.Constants.interactionTypeRedirect,
								this.redirectError,
					...
					UserAgentApplication.prototype.loginRedirect = function (userRequest) {
						...
						// validate request
						var request = RequestUtils_1.RequestUtils.validateRequest(
							userRequest,
							true,
							this.clientId,
							Constants_1.Constants.interactionTypeRedirect
					...
					UserAgentApplication.prototype.loginPopup = function (userRequest) {
						...
						var request = RequestUtils_1.RequestUtils.validateRequest(
							...
							true,
							this.clientId,
							Constants_1.Constants.interactionTypePopup
						);
						var apiEvent = this.telemetryManager.createAndStartApiEvent(
							request.correlationId,
							ApiEvent_1.API_EVENT_IDENTIFIER.LoginPopup
						);
						return new Promise(function (resolve, reject) {
					...
					UserAgentApplication.prototype.acquireTokenPopup = function (userRequest) {
						...
						var apiEvent = this.telemetryManager.createAndStartApiEvent(
							request.correlationId,
							ApiEvent_1.API_EVENT_IDENTIFIER.AcquireTokenPopup
						);
						return new Promise(function (resolve, reject) {
					 ...
					 * To renew idToken, please pass clientId as the only scope in the Authentication Parameters
					 */
					UserAgentApplication.prototype.acquireTokenInteractive = function (
						interactionType,
						isLoginCall,
						request,
						resolve,
						...
						if (interactionType === Constants_1.Constants.interactionTypeRedirect) {
							this.cacheStorage.setItem(
								Constants_1.TemporaryCacheKeys.REDIRECT_REQUEST,
								"" + Constants_1.Constants.inProgress + Constants_1.Constants.resourceDelimiter + request.state
							);
						}
					 ...
					 *
					 */
					UserAgentApplication.prototype.acquireTokenHelper = function (
						account,
						interactionType,
						isLoginCall,
						request,
							...
							return tslib_1.__generator(this, function (_a) {
								switch (_a.label) {
									case 0:
										...
										this.cacheStorage.setItem(
											Constants_1.TemporaryCacheKeys.INTERACTION_STATUS,
											Constants_1.Constants.inProgress
										);
									...
									case 1:
										...
										return [
											4 /*yield*/,
											AuthorityFactory_1.AuthorityFactory.saveMetadataFromNetwork(
												acquireTokenAuthority,
									...
									case 3:
										...
										_a.label = 4;
									case 4:
										responseType = isLoginCall
											? ResponseTypes.id_token
											: this.getTokenType(account, request.scopes, false);
										loginStartPage = request.redirectStartPage || window.location.href;
										serverAuthenticationRequest = new ServerRequestParameters_1.ServerRequestParameters(
											acquireTokenAuthority,
											this.clientId,
											responseType,
										...
										urlNavigate =
											UrlUtils_1.UrlUtils.createNavigateUrl(serverAuthenticationRequest) +
											Constants_1.Constants.response_mode_fragment;
										// set state in cache
										if (interactionType === Constants_1.Constants.interactionTypeRedirect) {
											if (!isLoginCall) {
												this.cacheStorage.setItem(
													AuthCache_1.AuthCache.generateTemporaryCacheKey(
														Constants_1.TemporaryCacheKeys.STATE_ACQ_TOKEN,
														request.state
													),
										...
										try {
											...
											this.logger.info(
												ClientAuthError_1.ClientAuthErrorMessage.popUpWindowError.code +
													":" +
													ClientAuthError_1.ClientAuthErrorMessage.popUpWindowError.desc
											);
											this.cacheStorage.setItem(
												Constants_1.ErrorCacheKeys.ERROR,
												ClientAuthError_1.ClientAuthErrorMessage.popUpWindowError.code
											);
											this.cacheStorage.setItem(
												Constants_1.ErrorCacheKeys.ERROR_DESC,
												ClientAuthError_1.ClientAuthErrorMessage.popUpWindowError.desc
											);
											if (reject) {
									...
									case 5:
										...
										return [
											4 /*yield*/,
											WindowUtils_1.WindowUtils.monitorPopupForHash(
												popUpWindow,
									...
									case 7:
										...
										if (this.config.framework.isAngular) {
											this.broadcast(
												"msal:popUpClosed",
												error_1.errorCode + Constants_1.Constants.resourceDelimiter + error_1.errorMessage
											);
										} else {
									...
									case 11:
										...
										this.authErrorHandler(
											interactionType,
											ClientAuthError_1.ClientAuthError.createEndpointResolutionError(err_1.toString),
											AuthResponse_1.buildResponseStateOnly(request.state),
											reject
										);
										if (popUpWindow) {
											popUpWindow.close();
					...
					UserAgentApplication.prototype.acquireTokenSilent = function (userRequest) {
						...
						var request = RequestUtils_1.RequestUtils.validateRequest(
							...
							false,
							this.clientId,
							Constants_1.Constants.interactionTypeSilent
						);
						var apiEvent = this.telemetryManager.createAndStartApiEvent(
							request.correlationId,
							ApiEvent_1.API_EVENT_IDENTIFIER.AcquireTokenSilent
						);
									...
									switch (_a.label) {
										case 0:
											...
											if (
												...
												StringUtils_1.StringUtils.isEmpty(adalIdToken)
											) {
												this.logger.info("User login is required");
										...
										case 6:
											...
											if (window.activeRenewals[requestSignature]) {
												...
												this.registerCallback(
													window.activeRenewals[requestSignature],
													requestSignature,
													resolve,
													reject
												);
												...
												if (
													request.scopes &&
													request.scopes.indexOf(this.clientId) > -1 &&
								...
								switch (_b.label) {
									case 0:
										...
										this.logger.verbosePii(
											"Set loading state to pending for: " + requestSignature + ":" + expectedState
										);
										this.cacheStorage.setItem(
											AuthCache_1.AuthCache.generateTemporaryCacheKey(
												Constants_1.TemporaryCacheKeys.RENEW_STATUS,
												expectedState
											),
											Constants_1.Constants.inProgress
										);
										...
										return [
											4 /*yield*/,
											WindowUtils_1.WindowUtils.loadFrame(
												urlNavigate,
												frameName,
									...
									case 4:
										...
										return [
											4 /*yield*/,
											WindowUtils_1.WindowUtils.monitorIframeForHash(
										...
										if (
											...
											this.logger.verbose(
												"Loading frame has timed out after: " +
													this.config.system.loadFrameTimeout / 1000 +
							...
							return tslib_1.__generator(this, function (_a) {
								switch (_a.label) {
									case 0:
										...
										apiEvent = this.telemetryManager.createAndStartApiEvent(
											requestCorrelationId,
											ApiEvent_1.API_EVENT_IDENTIFIER.Logout
										);
										this.clearCache();
										this.account = null;
										_a.label = 1;
					...
					UserAgentApplication.prototype.clearCache = function () {
						...
						window.renewStates = [];
						var accessTokenItems = this.cacheStorage.getAllAccessTokens(
					...
					UserAgentApplication.prototype.handleRedirectAuthenticationResponse = function (hash) {
						...
						if (this.config.auth.navigateToLoginRequestUrl && window.parent === window) {
							...
							var loginRequestUrl = this.cacheStorage.getItem(
								AuthCache_1.AuthCache.generateTemporaryCacheKey(
									Constants_1.TemporaryCacheKeys.LOGIN_REQUEST,
									stateInfo.state
								),
								this.inCookie
							);
					...
					UserAgentApplication.prototype.getResponseState = function (hash) {
						...
						if (
							stateResponse.state ===
								this.cacheStorage.getItem(
									AuthCache_1.AuthCache.generateTemporaryCacheKey(
										Constants_1.TemporaryCacheKeys.STATE_LOGIN,
										stateResponse.state
									),
									this.inCookie
								) ||
							stateResponse.state === this.silentAuthenticationState
						) {
					...
					UserAgentApplication.prototype.getCachedToken = function (serverAuthenticationRequest, account) {
						...
						var tokenCacheItems = this.cacheStorage.getAllAccessTokens(
							this.clientId,
						...
						if (!serverAuthenticationRequest.authority) {
							...
							if (filteredItems.length === 1) {
								...
								serverAuthenticationRequest.authorityInstance = AuthorityFactory_1.AuthorityFactory.CreateInstance(
						...
						// if an authority is passed in the API
							...
							for (var i = 0; i < tokenCacheItems.length; i++) {
								...
								var cachedScopes = cacheItem.key.scopes.split(" ");
								if (
									ScopeSet_1.ScopeSet.containsScope(cachedScopes, scopes) &&
									UrlUtils_1.UrlUtils.CanonicalizeUri(cacheItem.key.authority) === serverAuthenticationRequest.authority
								) {
									filteredItems.push(cacheItem);
								}
							}
						...
						if (accessTokenCacheItem != null) {
							...
							if (expired && expired > TimeUtils_1.TimeUtils.now() + offset) {
								...
								var response = {
									...
									tenantId: "",
									tokenType:
										accessTokenCacheItem.value.idToken === accessTokenCacheItem.value.accessToken
											? Constants_1.ServerHashParamKeys.ID_TOKEN
											: Constants_1.ServerHashParamKeys.ACCESS_TOKEN,
									idToken: idTokenObj,
					...
					UserAgentApplication.prototype.extractADALIdToken = function () {
						...
						return !StringUtils_1.StringUtils.isEmpty(adalIdToken)
							? TokenUtils_1.TokenUtils.extractIdToken(adalIdToken)
							: null;
					};
					/**
					 * @hidden
					...
					UserAgentApplication.prototype.renewToken = function (
						...
						var frameName = WindowUtils_1.WindowUtils.generateFrameName(
							Constants_1.FramePrefix.TOKEN_FRAME,
							requestSignature
						);
						...
						var urlNavigate =
							UrlUtils_1.UrlUtils.urlRemoveQueryStringParameter(
								UrlUtils_1.UrlUtils.createNavigateUrl(serverAuthenticationRequest),
					...
					UserAgentApplication.prototype.renewIdToken = function (
						...
						var frameName = WindowUtils_1.WindowUtils.generateFrameName(
							Constants_1.FramePrefix.ID_TOKEN_FRAME,
							requestSignature
						);
						WindowUtils_1.WindowUtils.addHiddenIFrame(frameName, this.logger);
						this.updateCacheEntries(serverAuthenticationRequest, account, false);
					...
					UserAgentApplication.prototype.saveAccessToken = function (
						...
						if (parameters.hasOwnProperty(Constants_1.ServerHashParamKeys.SCOPE)) {
							...
							var expiresIn = TimeUtils_1.TimeUtils.parseExpiresIn(
								parameters[Constants_1.ServerHashParamKeys.EXPIRES_IN]
							);
							var parsedState = RequestUtils_1.RequestUtils.parseLibraryState(
								parameters[Constants_1.ServerHashParamKeys.STATE]
							);
							expiration = parsedState.ts + expiresIn;
							var accessTokenKey = new AccessTokenKey_1.AccessTokenKey(
								authority,
								this.clientId,
								scope,
								clientObj.uid,
							...
							var accessTokenValue = new AccessTokenValue_1.AccessTokenValue(
								parameters[Constants_1.ServerHashParamKeys.ACCESS_TOKEN],
								idTokenObj.rawIdToken,
								expiration.toString(),
								clientInfo
							);
						...
						// if the response does not contain "scope" - scope is usually client_id and the token will be id_token
							...
							var accessTokenValue = new AccessTokenValue_1.AccessTokenValue(
								parameters[Constants_1.ServerHashParamKeys.ID_TOKEN],
								parameters[Constants_1.ServerHashParamKeys.ID_TOKEN],
								expiration.toString(),
								clientInfo
							);
					...
					UserAgentApplication.prototype.saveTokenFromHash = function (hash, stateInfo) {
						...
						if (
							hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION) ||
							hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.ERROR)
						) {
							this.logger.verbose("Server returned an error");
							this.logger.infoPii(
								"Error : " +
									hashParams[Constants_1.ServerHashParamKeys.ERROR] +
									"; Error description: " +
									hashParams[Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION]
							);
							this.cacheStorage.setItem(
								Constants_1.ErrorCacheKeys.ERROR,
								hashParams[Constants_1.ServerHashParamKeys.ERROR]
							...
							if (stateInfo.requestType === Constants_1.Constants.login) {
								...
								this.cacheStorage.setItem(
									Constants_1.ErrorCacheKeys.LOGIN_ERROR,
									hashParams[Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION] +
										":" +
										hashParams[Constants_1.ServerHashParamKeys.ERROR]
								);
							...
							if (stateInfo.requestType === Constants_1.Constants.renewToken) {
								...
								acquireTokenAccountKey = AuthCache_1.AuthCache.generateAcquireTokenAccountKey(
									accountId,
									stateInfo.state
								);
							}
							var _a = Constants_1.ServerHashParamKeys.ERROR,
								hashErr = hashParams[_a],
								_b = Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION,
								hashErrDesc = hashParams[_b];
							if (
								InteractionRequiredAuthError_1.InteractionRequiredAuthError.isInteractionRequiredError(hashErr) ||
								InteractionRequiredAuthError_1.InteractionRequiredAuthError.isInteractionRequiredError(hashErrDesc)
							) {
								error = new InteractionRequiredAuthError_1.InteractionRequiredAuthError(
									hashParams[Constants_1.ServerHashParamKeys.ERROR],
									hashParams[Constants_1.ServerHashParamKeys.ERROR_DESCRIPTION]
								);
							} else {
						...
						// If the server returns "Success"
							...
							if (stateInfo.stateMatch) {
								...
								if (hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.SESSION_STATE)) {
									...
									this.cacheStorage.setItem(
										AuthCache_1.AuthCache.generateTemporaryCacheKey(
											Constants_1.TemporaryCacheKeys.SESSION_STATE,
											stateInfo.state
										),
										hashParams[Constants_1.ServerHashParamKeys.SESSION_STATE]
									);
								}
								...
								if (hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.ACCESS_TOKEN)) {
									...
									if (hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.ID_TOKEN)) {
										...
										idTokenObj = new IdToken_1.IdToken(
											this.cacheStorage.getItem(Constants_1.PersistentCacheKeys.IDTOKEN)
										);
									...
									response.account = Account_1.Account.createAccount(
										idTokenObj,
									...
									var acquireTokenAccountKey_noaccount = AuthCache_1.AuthCache.generateAcquireTokenAccountKey(
									...
									if (!StringUtils_1.StringUtils.isEmpty(cachedAccount)) {
										...
										if (
											response.account &&
											acquireTokenAccount &&
											Account_1.Account.compareAccounts(response.account, acquireTokenAccount)
										) {
										...
										!StringUtils_1.StringUtils.isEmpty(this.cacheStorage.getItem(acquireTokenAccountKey_noaccount))
									) {
								...
								if (hashParams.hasOwnProperty(Constants_1.ServerHashParamKeys.ID_TOKEN)) {
									...
									if (idTokenObj && idTokenObj.nonce) {
										...
										var cachedNonce = this.cacheStorage.getItem(
											AuthCache_1.AuthCache.generateTemporaryCacheKey(
												Constants_1.TemporaryCacheKeys.NONCE_IDTOKEN,
												stateInfo.state
											),
											this.inCookie
										);
										if (idTokenObj.nonce !== cachedNonce) {
											...
											this.cacheStorage.setItem(
												Constants_1.ErrorCacheKeys.LOGIN_ERROR,
												"Nonce Mismatch. Expected Nonce: " + cachedNonce + "," + "Actual Nonce: " + idTokenObj.nonce
											);
											this.logger.error(
												"Nonce Mismatch. Expected Nonce: " + cachedNonce + ", Actual Nonce: " + idTokenObj.nonce
											);
										...
										// Save the token
											...
											this.cacheStorage.setItem(
												Constants_1.PersistentCacheKeys.IDTOKEN,
												hashParams[Constants_1.ServerHashParamKeys.ID_TOKEN],
												this.inCookie
											);
							...
							// State mismatch - unexpected/invalid state
								...
								this.logger.error(
									"State Mismatch. Expected State: " + expectedState + ", Actual State: " + stateInfo.state
								);
					...
					UserAgentApplication.prototype.populateAuthority = function (state, inCookie, cacheStorage, idTokenObj) {
						...
						return StringUtils_1.StringUtils.isEmpty(cachedAuthority)
							? cachedAuthority
							: UrlUtils_1.UrlUtils.replaceTenantPath(cachedAuthority, idTokenObj.tenantId);
					};
					...
					UserAgentApplication.prototype.getAllAccounts = function () {
						var accounts = [];
						var accessTokenCacheItems = this.cacheStorage.getAllAccessTokens(
							Constants_1.Constants.clientId,
							Constants_1.Constants.homeAccountIdentifier
						);
						for (var i = 0; i < accessTokenCacheItems.length; i++) {
					...
					UserAgentApplication.prototype.getCachedTokenInternal = function (scopes, account, state, correlationId) {
						...
						var newAuthority = this.authorityInstance
							? this.authorityInstance
							: AuthorityFactory_1.AuthorityFactory.CreateInstance(this.authority, this.config.auth.validateAuthority);
						var responseType = this.getTokenType(accountObject, scopes, true);
						var serverAuthenticationRequest = new ServerRequestParameters_1.ServerRequestParameters(
							newAuthority,
							this.clientId,
							responseType,
							this.getRedirectUri(),
					...
					UserAgentApplication.prototype.getScopesForEndpoint = function (endpoint) {
						...
						if (this.config.framework.protectedResourceMap.size > 0) {
							for (
								var _i = 0, _a = Array.from(this.config.framework.protectedResourceMap.keys());
								_i < _a.length;
								_i++
							) {
								var key = _a[_i];
						...
						if (endpoint.indexOf("http://") > -1 || endpoint.indexOf("https://") > -1) {
							if (
								UrlUtils_1.UrlUtils.getHostFromUri(endpoint) ===
								UrlUtils_1.UrlUtils.getHostFromUri(this.getRedirectUri())
							) {
					...
					UserAgentApplication.prototype.getLoginInProgress = function () {
						return (
							this.cacheStorage.getItem(Constants_1.TemporaryCacheKeys.INTERACTION_STATUS) ===
							Constants_1.Constants.inProgress
						);
					};
					/**
					...
					UserAgentApplication.prototype.getTokenType = function (accountObject, scopes, silentCall) {
						...
						if (silentCall) {
							if (Account_1.Account.compareAccounts(accountObject, this.getAccount())) {
								tokenType =
									scopes.indexOf(this.config.auth.clientId) > -1 ? ResponseTypes.id_token : ResponseTypes.token;
							} else {
								tokenType =
									scopes.indexOf(this.config.auth.clientId) > -1
										? ResponseTypes.id_token
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var ServerRequestParameters = /** @class */ (function () {
					 ...
					 * @param serverAuthenticationRequest
					 */
					ServerRequestParameters.prototype.populateQueryParams = function (
						account,
						request,
						adalIdTokenObject,
						silentCall
					...
					ServerRequestParameters.prototype.addHintParameters = function (account, qParams) {
						...
						if (account && !qParams[Constants_1.SSOTypes.SID]) {
							...
							var populateSID =
								!qParams[Constants_1.SSOTypes.LOGIN_HINT] &&
								account.sid &&
								this.promptValue === Constants_1.PromptState.NONE;
							if (populateSID) {
							...
							// login_hint - account.userName
								...
								var populateLoginHint =
									!qParams[Constants_1.SSOTypes.LOGIN_HINT] &&
									account.userName &&
									!StringUtils_1.StringUtils.isEmpty(account.userName);
					...
					ServerRequestParameters.generateQueryParametersString = function (queryParameters, silentCall) {
						...
						if (queryParameters) {
							Object.keys(queryParameters).forEach(function (key) {
								...
								if (
									key === Constants_1.Constants.domain_hint &&
									(silentCall || queryParameters[Constants_1.SSOTypes.SID])
								) {
									return;
								}
				...
				var RequestUtils = /** @class */ (function () {
					...
					RequestUtils.validateRequest = function (request, isLoginCall, clientId, interactionType) {
						...
						if (request) {
							...
							scopes = isLoginCall
								? ScopeSet_1.ScopeSet.appendScopes(request.scopes, request.extraScopesToConsent)
								: request.scopes;
					...
					RequestUtils.validateAndGenerateState = function (userState, interactionType) {
						return !StringUtils_1.StringUtils.isEmpty(userState)
							? "" +
									RequestUtils.generateLibraryState(interactionType) +
					...
					RequestUtils.validateAndGenerateCorrelationId = function (correlationId) {
						...
						return CryptoUtils_1.CryptoUtils.isGuid(correlationId)
							? correlationId
							: CryptoUtils_1.CryptoUtils.createNewGuid();
					};
					/**
					...
					RequestUtils.createRequestSignature = function (request) {
						return (
							"" + request.scopes.join(" ").toLowerCase() + Constants_1.Constants.resourceDelimiter + request.authority
						);
					};
					return RequestUtils;
				})();
					...
					Account.createAccount = function (idToken, clientInfo) {
						...
						if (!StringUtils_1.StringUtils.isEmpty(uid) && !StringUtils_1.StringUtils.isEmpty(utid)) {
							homeAccountIdentifier =
								CryptoUtils_1.CryptoUtils.base64Encode(uid) + "." + CryptoUtils_1.CryptoUtils.base64Encode(utid);
						}
						return new Account(
							accountIdentifier,
							homeAccountIdentifier,
					...
					AuthorityFactory.saveMetadataFromConfig = function (authorityUrl, authorityMetadataJson) {
						try {
							if (authorityMetadataJson) {
								...
								if (
									!parsedMetadata.authorization_endpoint ||
									!parsedMetadata.end_session_endpoint ||
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var Authority = /** @class */ (function () {
					...
					Authority.prototype.DiscoverEndpoints = function (
						...
						var httpEvent = telemetryManager.createAndStartHttpEvent(
							correlationId,
							httpMethod,
							openIdConfigurationEndpoint,
							"openIdConfigurationEndpoint"
						...
						return client
							.sendRequestAsync(openIdConfigurationEndpoint, httpMethod, /* enableCaching: */ true)
							...
							return tslib_1.__generator(this, function (_b) {
								switch (_b.label) {
									case 0:
										...
										if (!(TrustedAuthority_1.TrustedAuthority.getTrustedHostList().length === 0))
											return [3 /*break*/, 2];
										return [
											4 /*yield*/,
											TrustedAuthority_1.TrustedAuthority.setTrustedAuthoritiesFromNetwork(
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var TrustedAuthority = /** @class */ (function () {
						...
						return tslib_1.__awaiter(this, void 0, Promise, function () {
							...
							return tslib_1.__generator(this, function (_a) {
								...
								instanceDiscoveryEndpoint =
									"" + Constants_1.AAD_INSTANCE_DISCOVERY_ENDPOINT + authorityToVerify + "oauth2/v2.0/authorize";
								httpEvent = telemetryManager.createAndStartHttpEvent(
									correlationId,
									httpMethod,
									instanceDiscoveryEndpoint,
									"getAliases"
								...
								return [
									2 /*return*/,
									client
										.sendRequestAsync(instanceDiscoveryEndpoint, httpMethod, true)
										.then(function (response) {
											httpEvent.httpResponseStatus = response.statusCode;
											telemetryManager.stopEvent(httpEvent);
					 ...
					 * @param correlationId
					 */
					TrustedAuthority.setTrustedAuthoritiesFromNetwork = function (
						authorityToVerify,
						telemetryManager,
						correlationId
					) {
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var DEFAULT_AUTH_OPTIONS = {
					...
					redirectUri: function () {
						return UrlUtils_1.UrlUtils.getCurrentUrl();
					},
				...
				var ApiEvent = /** @class */ (function (_super) {
					...
					function ApiEvent(correlationId, piiEnabled, apiEventIdentifier) {
						var _this =
							_super.call(
								this,
								TelemetryUtils_1.prependEventNamePrefix("api_event"),
								correlationId,
								apiEventIdentifier
							) || this;
					...
					Object.defineProperty(ApiEvent.prototype, "tenantId", {
						set: function (tenantId) {
							this.event[exports.EVENT_KEYS.TENANT_ID] =
								this.piiEnabled && tenantId ? TelemetryUtils_1.hashPersonalIdentifier(tenantId) : null;
						},
						enumerable: true,
						configurable: true,
					});
					Object.defineProperty(ApiEvent.prototype, "accountId", {
						set: function (accountId) {
							this.event[exports.EVENT_KEYS.USER_ID] =
								this.piiEnabled && accountId ? TelemetryUtils_1.hashPersonalIdentifier(accountId) : null;
						},
						enumerable: true,
						configurable: true,
					});
					...
					Object.defineProperty(ApiEvent.prototype, "loginHint", {
						set: function (loginHint) {
							this.event[exports.EVENT_KEYS.LOGIN_HINT] =
								this.piiEnabled && loginHint ? TelemetryUtils_1.hashPersonalIdentifier(loginHint) : null;
						},
						enumerable: true,
						configurable: true,
					});
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var AuthCache = /** @class */ (function (_super) {
					...
					AuthCache.prototype.migrateCacheEntries = function (storeAuthStateInCookie) {
						...
						var keysToMigrate = [
							Constants_1.PersistentCacheKeys.IDTOKEN,
							Constants_1.PersistentCacheKeys.CLIENT_INFO,
							Constants_1.ErrorCacheKeys.ERROR,
							Constants_1.ErrorCacheKeys.ERROR_DESC,
						];
					...
					AuthCache.prototype.generateCacheKey = function (key, addInstanceId) {
						try {
							...
							if (
								key.indexOf("" + Constants_1.Constants.cachePrefix) === 0 ||
								key.indexOf(Constants_1.Constants.adalIdToken) === 0
							) {
								return key;
							}
							return addInstanceId
								? Constants_1.Constants.cachePrefix + "." + this.clientId + "." + key
								: Constants_1.Constants.cachePrefix + "." + key;
						}
					};
					/**
					...
					AuthCache.prototype.getAllAccessTokens = function (clientId, homeAccountIdentifier) {
						...
						var results = Object.keys(window[this.cacheLocation]).reduce(function (tokens, key) {
							var keyMatches =
								key.match(clientId) && key.match(homeAccountIdentifier) && key.match(Constants_1.Constants.scopes);
							if (keyMatches) {
								var value = _this.getItem(key);
								if (value) {
									try {
										var parseAtKey = JSON.parse(key);
										var newAccessTokenCacheItem = new AccessTokenCacheItem_1.AccessTokenCacheItem(
											parseAtKey,
											JSON.parse(value)
										);
					...
					AuthCache.prototype.tokenRenewalInProgress = function (stateValue) {
						var renewStatus = this.getItem(
							AuthCache.generateTemporaryCacheKey(Constants_1.TemporaryCacheKeys.RENEW_STATUS, stateValue)
						);
					...
					AuthCache.prototype.clearMsalCookie = function (state) {
						...
						if (state) {
							this.clearItemCookie(
								AuthCache.generateTemporaryCacheKey(Constants_1.TemporaryCacheKeys.NONCE_IDTOKEN, state)
							);
							this.clearItemCookie(
								AuthCache.generateTemporaryCacheKey(Constants_1.TemporaryCacheKeys.STATE_LOGIN, state)
							);
							this.clearItemCookie(
								AuthCache.generateTemporaryCacheKey(Constants_1.TemporaryCacheKeys.LOGIN_REQUEST, state)
							);
							this.clearItemCookie(
								AuthCache.generateTemporaryCacheKey(Constants_1.TemporaryCacheKeys.STATE_ACQ_TOKEN, state)
							);
						} else {
					...
					AuthCache.generateAcquireTokenAccountKey = function (accountId, state) {
						...
						return (
							"" +
							Constants_1.TemporaryCacheKeys.ACQUIRE_TOKEN_ACCOUNT +
							Constants_1.Constants.resourceDelimiter +
							accountId +
							Constants_1.Constants.resourceDelimiter +
							stateId
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var BrowserStorage = /** @class */ (function () {
					function BrowserStorage(cacheLocation) {
						if (!window) {
							throw AuthError_1.AuthError.createNoWindowObjectError(
				...
				var TelemetryManager = /** @class */ (function () {
					function TelemetryManager(config, telemetryEmitter, logger) {
						...
						this.telemetryPlatform = tslib_1.__assign(
							{
								sdk: Constants_1.Constants.libraryName,
								sdkVersion: Constants_1.libraryVersion(),
								networkInformation: {
									// @ts-ignore
									connectionSpeed:
										typeof navigator !== "undefined" && navigator.connection && navigator.connection.effectiveType,
								},
							},
							config.platform
						);
					...
					TelemetryManager.prototype.flush = function (correlationId) {
						...
						var defaultEvent = new DefaultEvent_1.default(
						...
						this.telemetryEmitter(
							eventsWithDefaultEvent.map(function (e) {
								return e.get();
							})
						);
					};
					...
					TelemetryManager.prototype.stopAndFlushApiEvent = function (
						correlationId,
						apiEvent,
						wasSuccessful,
						errorCode
				...
				var DefaultEvent = /** @class */ (function (_super) {
					...
					function DefaultEvent(platform, correlationId, clientId, eventCount) {
						var _this =
							_super.call(
								this,
								TelemetryUtils_1.prependEventNamePrefix("default_event"),
								correlationId,
								"DefaultEvent"
							) || this;
						...
						_this.event[TelemetryUtils_1.prependEventNamePrefix("effective_connection_speed")] =
							platform.networkInformation && platform.networkInformation.connectionSpeed;
						_this.event[
							"" + TelemetryConstants_1.TELEMETRY_BLOB_EVENT_NAMES.UiEventCountTelemetryBatchKey
						] = _this.getEventCount(TelemetryUtils_1.prependEventNamePrefix("ui_event"), eventCount);
						_this.event[
							"" + TelemetryConstants_1.TELEMETRY_BLOB_EVENT_NAMES.HttpEventCountTelemetryBatchKey
						] = _this.getEventCount(TelemetryUtils_1.prependEventNamePrefix("http_event"), eventCount);
						_this.event[
							"" + TelemetryConstants_1.TELEMETRY_BLOB_EVENT_NAMES.CacheEventCountConstStrKey
						] = _this.getEventCount(TelemetryUtils_1.prependEventNamePrefix("cache_event"), eventCount);
						return _this;
						// / Device id?
					}
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var HttpEvent = /** @class */ (function (_super) {
					...
					function HttpEvent(correlationId, eventLabel) {
						return (
							_super.call(this, TelemetryUtils_1.prependEventNamePrefix("http_event"), correlationId, eventLabel) ||
							this
						);
					}
					...
					Object.defineProperty(HttpEvent.prototype, "queryParams", {
						set: function (queryParams) {
							this.event[
								exports.EVENT_KEYS.QUERY_PARAMETERS
							] = ServerRequestParameters_1.ServerRequestParameters.generateQueryParametersString(queryParams);
						},
						enumerable: true,
						configurable: true,
					});
