...
const UserProfilePanel = (props) => {
    console.log('----panelState-current-->', props.panelState)
    if (!props.panelState) { return null };
    ...
    return (
        <Customizer scopedSettings={{ Layer: { hostId: "main_layer" } }}>
            <Panel
...
// /<CardConfigureExample /> <Form schema={schema} />
